...
class GreenAnalyzer:
    ...
    Тепловой комфорт (тень/экспозиция) считается отдельно в :mod:`services.heat`:
    крона деревьев и трава по-разному ослабляют солнечный штраф — «зелень как
    таковая» не равна тепловому бонусу без учёта ориентации и слота времени.
    """
